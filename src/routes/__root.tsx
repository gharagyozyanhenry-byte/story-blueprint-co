...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "MathMind Tutoring" },
      ...
      { property: "og:description", content: "Private math tutoring in Glendale, California. From algebra to calculus — building real understanding, not memorization." },
      { name: "twitter:description", content: "Private math tutoring in Glendale, California. From algebra to calculus — building real understanding, not memorization." },
    ],
    links: [
